...
`;
  ...
  const phone = "573107249827"; // ← cambia por tu número
      ...
      >
        ...
        <div className="flex-1 overflow-y-auto p-5">
          ...
          {cart.map((item) => (
            ...
            >
              ...
              <div className="relative h-28 w-28 rounded-xl bg-gray-100">
                ...
                <div className="flex justify-between">
                  ...
                  <div>
                    ...
                    <p className="mt-2 text-sm text-gray-500">
                      ...
                      {item.brand.name} · Talla {item.size}
        ...
        <div className="border-t px-8 py-8">
          ...
          <button
            ...
            className="mt-8 w-full rounded-2xl bg-black py-4 text-lg font-bold text-white transition hover:bg-red-600" >          
              Finalizar compra
          </button>
