...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      ...
      <div
        className="pointer-events-none absolute right-20 top-1/2 -translate-y-1/2 whitespace-nowrap rounded-full bg-black px-4 py-2 text-sm font-medium text-white opacity-0 shadow-xl transition-all duration-300 group-hover:opacity-100"
      >
      ...
      <div className="flex h-16 w-16 animate-[pulse_6s_infinite] items-center justify-center rounded-full bg-[#25D366] shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-green-400/60">
